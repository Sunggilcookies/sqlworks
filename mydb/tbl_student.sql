...
INSERT INTO tbl_student VALUES (20211235, '박대양', 25, '남자', '경기도 성남시', 102);
INSERT INTO tbl_student VALUES (20211236, '한비야', 23, '여자', '경기도 수원시', 102);
...
--주소가 경기도이고 남자인 학생을 검색하시오.
SELECT * FROM tbl_student
Where address LIKE '경기도%'
AND gender ='남자';
--나이가 많은순으로 정렬하시오
SELECT * FROM tbl_student ORDER BY age DESC;
4.박대양의 나이를 30세로 변경하시오.
UPDATE tbl_student SET aage= 30 WHERE sname = '박대양';

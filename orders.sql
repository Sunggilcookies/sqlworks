...
--INSERT INTO orders VALUES (11,6,8,13000,TO_DATE('2018-07-10','YYYY-MM-DD'));

SELECT * FROM orders;

--고객이 주문한 도서의 총 판매액을 구하시오
SELECT SUM(saleprice)총판매액, AVG(saleprice) 평균금액 FROM oders;
...
--2q번 고객 김연아가 주문한 도서의 총판매액을 구하시오
--조인(1개 테이블 이상 연결하는 방법)
...
--집계를 구할때는 group by 절을 사용
-- HAVING절은 GROUP BY의 질의 결과 나타내는 그룹을 제한하는 역활
